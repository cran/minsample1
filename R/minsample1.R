...
#' @details in any distribution for a large sample, the absolute error gradually tends to zero, the minimum number depends on the precision level i.e. the pre-fixed eplison
